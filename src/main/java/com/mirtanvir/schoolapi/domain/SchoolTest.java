...
public class SchoolTest {
	...
	public static void main(String[] args) {
		FileSystemXmlApplicationContext ctx = new FileSystemXmlApplicationContext(
				"D:/Users/245546/src/schoolapi/src/main/resources/META-INF/spring/root-context.xml");
	...
	public void start(String[] args) {
		...
		// List<School> schools = schoolDao.findAllSchool(); //Deleted by kabir
		// add later

		// listContacts(schools);//Deleted by kabir add later

		// List contacts with details
		// schools = schoolDao.findAllSchoolWithDetail();//Deleted by kabir add
		// later
		...
		/*
		 * Temporarily commented School myschool = new School();
		 * myschool.setName("Mission High Elementary");
		 * myschool.setApiScore(950); myschool.setCity("Freemont");
		 * myschool.setState("CA"); myschool.setZip("95051");
		 * //myschool.setId(4);
		 * 
		 * System.out.println("School Without schoold id:" + myschool);
		 * 
		 * DemographicAPI myapi=new DemographicAPI();
		 * myapi.setDemographicType("Hispanic"); myapi.setApiScore(750);
		 * //myapi.setId(5); DemographicAPI my_api1=new DemographicAPI();
		 * my_api1.setDemographicType("Asian"); my_api1.setApiScore(980);
		 * //myapi1.setId(6);
		 * 
		 ...
		 * 
		 * System.out.println(
		 * "MY SCHOOL After Adding New Dempgraphic Api in the Hash list and Before saving  "
		 * + myschool);
		 */

		// List <School> retrieveSchool=schoolDao.findAllSchool();

		School retrieveSchool = schoolDao.findSchoolById((long) 102);

		System.out.println("School Retrieve from DataBase Here:  "
				+ retrieveSchool);

		retrieveSchool = schoolDao
				.getSchoolWithCommentsAndDemographicsDetails(100L);
		System.out.println(retrieveSchool);
		if (retrieveSchool != null) {
		 ...
		 * 
		 * Set <DemographicAPI>
		 * retrivedDemographicapi=retrieveSchool.getDemographicAPIdetails();
		 * 
		 * 
		 ...
		 * Asianapi.setDemographicType("Asian"); Asianapi.setApiScore(900);
		 * 
		 ...
		 * 
		 * System.out.println("Found one school with : "
		 * +eachApi.getDemographicType()+"Demographic Type");
		 * eachApi.setDemographicType("Indian"); eachApi.setApiScore(900); }
		 * 
		 * }
		 */
		/*
		 ...
		 * 
		 * System.out.println("Found one school with : "
		 * +eachApi.getDemographicType()+"Demographic Type"); deleteApi=eachApi;
		 * 
		 * 
		 * //eachApi.setDemographicType("Indian"); //eachApi.setApiScore(900); }
		 * 
		 ...
		 * 
		 * myComments.setComment(
		 * "2014 Year school will be started on August 18,2014");
		 * 
		 ...
		 * myschool.setApiScore(850); myschool.setCity("Hayward");
		 * myschool.setState("CA"); myschool.setZip("95051");
		 * 
		 * DemographicAPI Africanapi=new DemographicAPI();
		 * Africanapi.setDemographicType("African American");
		 ...
		 * 
		 * 
		 * SchoolComment myComments=new SchoolComment(); myComments.setComment(
		 * "2014 Year school will be started on August 18,2014");
		 * 
		 ...
		 * 
		 * 
		 * School school1 = schoolDao.findSchoolById(2L); DemographicAPI api =
		 * new DemographicAPI(); api.setApiScore(896);
		 * api.setDemographicType("fas"); api.setId(10);
		 * school1.getDemographicAPIdetails().add(api);
		 * schoolDao.saveSchool(school1); System.out.println(school1);
		 * 
		 * 
		 * /*List <School> myschools = schoolDao.findAllSchoolWithDetail();
		 * listSchoolsWithDetail(myschools);
